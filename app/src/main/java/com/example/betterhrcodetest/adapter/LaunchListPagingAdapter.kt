...
class LaunchListPagingAdapter :
    PagingDataAdapter<LaunchListQuery.Launch, LaunchListPagingAdapter.ViewHolder>(
        DataDifferntiator
    ) {
    ...
    object DataDifferntiator : DiffUtil.ItemCallback<LaunchListQuery.Launch>() {
